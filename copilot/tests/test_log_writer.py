...
class TestLogWriter(unittest.TestCase):
    @patch("common.logs.logwriter.os.makedirs")
    @patch("common.logs.logwriter.RotatingFileHandler")
    ...
    @patch("common.logs.logwriter.os.makedirs")
    @patch("common.logs.logwriter.RotatingFileHandler")
    @patch("common.logs.logwriter.logging.Logger.info")
    ...
    @patch("common.logs.logwriter.os.makedirs")
    @patch("common.logs.logwriter.RotatingFileHandler")
    @patch("common.logs.logwriter.logging.Logger.warning")
    ...
    @patch("common.logs.logwriter.os.makedirs")
    @patch("common.logs.logwriter.RotatingFileHandler")
    @patch("common.logs.logwriter.logging.Logger.error")
