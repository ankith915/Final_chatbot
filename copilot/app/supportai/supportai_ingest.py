from common1.metrics.tg_proxy import TigerGraphConnectionProxy
from common1.storage.azure_blob_store import AzureBlobStore
from common1.storage.google_blob_store import GoogleBlobStore
from common1.storage.s3_blob_store import S3BlobStore
from common1.py_schemas import BatchDocumentIngest, Document, DocumentChunk, KnowledgeGraph
from typing import List, Union
import json
from datetime import datetime
from common1.status import Status, IngestionProgress
from common1.extractors import LLMEntityRelationshipExtractor
...
class BaseIngestion:
    ...
    def chunk_document(self, document, chunker, chunker_params):
        if chunker.lower() == "regex":
            from common1.chunkers.regex_chunker import RegexChunker
